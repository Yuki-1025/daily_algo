 ...
 *
 */
// divide and conquer => usually recursion
//1. split the array in half
//2. sort left half; sort right harf
...
//create merge function [important], REFER TO mergeSortedArray
const merge = function(nums1, nums2) {
  ...
  // check if remaining and push the remaining
  if (i < nums1.length) {
